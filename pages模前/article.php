        ...
        <?php foreach ($rowsType as $type) : ?>
          <li class="nav-item">
            ...
            <?php
              ...
              ?>" aria-current="page" href="article.php?cate=<?= $type["id"] ?>"><?= $type["name"] ?></a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="articlebox"><button data-bs-toggle="modal" data-bs-target="#confrimModal<?=$article["id"]?>" class="btn btn-danger " type="button">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <li class="page-item <?php if ($i == $p) echo "active"; ?>">
                    <a class="page-link" href="article.php?order=<?= $order ?>&p=<?= $i ?>"><?= $i ?></a>
                </li>
                <?php endfor; ?>
                <?php else : ?>
                <?php for ($i = 1; $i <= $pageCount; $i++) : ?>
                <li class="page-item <?php if ($i == $p) echo "active"; ?>">
                    <a class="page-link" href="article.php?order=<?= isset($_GET["order"]) ? $_GET["order"] : 1 ?>&p=<?= $i ?>&search=<?= isset($_GET["search"]) ? $_GET["search"] : '' ?>"><?= $i ?></a>
                </li>
                <?php endfor; ?>
                <?php endif ?>
            </ul>
